...
import { createCourseInstanceSchema } from '@/app/lib/createCourseInstanceSchema'
...
import SemesterSelect from '@/app/components/dashboard/admin/forms/Semester-select'
import TeacherSelect from '@/app/components/dashboard/admin/forms/Teacher-select'
import CourseSelect from '@/app/components/dashboard/admin/forms/Course-select'
