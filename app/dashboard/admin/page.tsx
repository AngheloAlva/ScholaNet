    ...
    <div key="1" className="flex flex-col w-full min-h-screen">
      ...
      <main className="flex min-h-[calc(100vh-_theme(spacing.16))] flex-1 flex-col gap-4 p-4 md:gap-8 md:p-10">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <DataCard title='Total Students' value={2350} percentage={'+180.1%'} icon={<FiUsers className="w-4 h-4 text-gray-500 dark:text-gray-400" />} />
          <DataCard title='Total Courses' value={75} percentage={'+19%'} icon={<FiBook className="w-4 h-4 text-gray-500 dark:text-gray-400" />} />
          <DataCard title='Total Teachers' value={120} percentage={'+10%'} icon={<PiChalkboardTeacher className="w-4 h-4 text-gray-500 dark:text-gray-400" />} />
          <DataCard title='Total Guardians' value={500} percentage={'+15%'} icon={<FiShield className="w-4 h-4 text-gray-500 dark:text-gray-400" />} />
        </div>
        <div>
          <TableCard
